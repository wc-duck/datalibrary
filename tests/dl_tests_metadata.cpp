...
TYPED_TEST( DLBase, metadata_type )
{
	...
	EXPECT_DL_ERR_OK( dl_get_metadata_cnt( DL::Ctx, type_with_meta::TYPE_ID, &metadata_count ) );
...
{
	uint32_t metadata_count;
	EXPECT_DL_ERR_OK( dl_get_member_metadata_cnt( DL::Ctx, type_with_meta::TYPE_ID, 0, &metadata_count ) );
	EXPECT_EQ( 2U, metadata_count );
	dl_typeid_t metadata_type_id;
	uint32_t metadata_instance_size;
	void* metadata_instance;
...
{
	uint32_t metadata_count;
	EXPECT_DL_ERR_OK( dl_get_metadata_cnt( DL::Ctx, EnumWithMeta_TYPE_ID, &metadata_count ) );
	EXPECT_EQ( 2U, metadata_count );
	dl_typeid_t metadata_type_id;
	uint32_t metadata_instance_size;
	void* metadata_instance;
...
{
	uint32_t metadata_count;
	EXPECT_DL_ERR_OK( dl_get_member_metadata_cnt( DL::Ctx, EnumWithMeta_TYPE_ID, 0, &metadata_count ) );
	EXPECT_EQ( 2U, metadata_count );
	dl_typeid_t metadata_type_id;
	uint32_t metadata_instance_size;
	void* metadata_instance;
...
{
	uint32_t metadata_count;
	EXPECT_DL_ERR_OK( dl_get_metadata_cnt( DL::Ctx, test_union_simple::TYPE_ID, &metadata_count ) );
	EXPECT_EQ( 2U, metadata_count );
	dl_typeid_t metadata_type_id;
	uint32_t metadata_instance_size;
	void* metadata_instance;
...
{
	uint32_t metadata_count;
	EXPECT_DL_ERR_OK( dl_get_member_metadata_cnt( DL::Ctx, test_union_simple::TYPE_ID, 2, &metadata_count ) );
