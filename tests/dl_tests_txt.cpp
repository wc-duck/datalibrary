...
TEST_F(DLText, member_order)
{
	...
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, Pods::TYPE_ID, &P1, sizeof(Pods), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_pod)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, PodsDefaults::TYPE_ID, &P1, sizeof(P1), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_string)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultStr::TYPE_ID, P1, sizeof(P1), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_ptr)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultPtr::TYPE_ID, &P1, sizeof(DefaultPtr), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_struct)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultStruct::TYPE_ID, &P1, sizeof(DefaultStruct), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_enum)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultEnum::TYPE_ID, &P1, sizeof(DefaultEnum), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_inline_array_pod)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultInlArrayPod::TYPE_ID, &P1, sizeof(DefaultInlArrayPod), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_inline_array_enum)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultInlArrayEnum::TYPE_ID, &P1, sizeof(DefaultInlArrayEnum), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_inline_array_string)
{
	...
	// load binary
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultInlArrayStr::TYPE_ID, P1, sizeof(P1), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_array_pod)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultArrayPod::TYPE_ID, P1, sizeof(P1), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_array_enum)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultArrayEnum::TYPE_ID, P1, sizeof(P1), OutDataText, 1024));
...
TEST_F(DLText, defalut_value_array_string)
{
	...
	EXPECT_DL_ERR_OK(dl_txt_pack(Ctx, TextData, OutDataText, 1024));
	EXPECT_DL_ERR_OK(dl_instance_load(Ctx, DefaultArrayStr::TYPE_ID, P1, sizeof(P1), OutDataText, 1024));
