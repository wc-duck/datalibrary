							  ...
							  unsigned char* out_buffer, size_t      out_buffer_size, size_t*     produced_bytes )
{
	...
	store_context.AddWrittenPtr( (const uint8_t*)instance, sizeof( dl_data_header ) ); // if pointer refere to root-node, it can be found at offset "sizeof(dl_data_header)"
